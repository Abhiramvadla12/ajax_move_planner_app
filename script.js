...
function loadData() {
    ...
    let apiKey = "AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg"; 

    let streetViewUrl = `https://maps.googleapis.com/maps/api/streetview?size=600x300&location=${encodeURIComponent(address)}&key=${apiKey}`;
    ...
    url += '?q=' + street + '&sort=newest&' + $.param({
        'api-key': "GzeCpFKDcPAsdYQCmFlEmJAkRIylZCxV"
    });
    $.ajax({
        url: url,
        method: 'GET'
